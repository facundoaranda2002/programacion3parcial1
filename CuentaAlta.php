...
isset($_POST['Nro_Documento']) && isset($_POST['Email']) && isset($_POST['Tipo_de_Cuenta']))
{
    ...
    $_POST['Tipo_de_Cuenta'] == 'CAU$S' || $_POST['Tipo_de_Cuenta'] == 'CCU$S')
    {
        $clienteAux;
        if(isset($_POST['Saldo_Inicial']))
        {
            
            $clienteAux = new Cliente($_POST["Nombre"],$_POST["Apellido"],$_POST["Tipo_Documento"],$_POST["Nro_Documento"],$_POST["Email"],$_POST["Tipo_de_Cuenta"],$_POST["Saldo_Inicial"]);   
        }
        else
        {
            $clienteAux = new Cliente($_POST["Nombre"],$_POST["Apellido"],$_POST["Tipo_Documento"],$_POST["Nro_Documento"],$_POST["Email"],$_POST["Tipo_de_Cuenta"]);
        }
