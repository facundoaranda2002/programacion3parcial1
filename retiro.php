...
class Retiro
{
    ...
    public function __construct($nombre, $apellido, $tipoDocumento, $numeroDocumento, $email, $tipoDeCuenta, $saldoInicial, $nroDeCuenta, $nroRetiro = null, $fecha = null, $monto)
    {
        $this->_nombre= $nombre;
    ...
    public static function ObtenerRetiros()
    {
        ...
        if(file_exists($rutaArchivo))
        {
            ...
            {              
                $nuevoRetiro = new Retiro($Retiro["_nombre"], $Retiro["_apellido"], $Retiro["_tipoDocumento"], $Retiro["_numeroDocumento"], $Retiro["_email"], $Retiro["_tipoDeCuenta"], $Retiro["_saldoInicial"], $Retiro["_nroDeCuenta"], $Retiro["_nroDeRetiro"], $Retiro["_fecha"], $Retiro["_monto"]);
    ...
    public static function BuscarTotalRetirado($TipoDeCuenta, $fecha = null)
    {
        $montoTotal = 0;
        if($fecha == null)
        {
        ...
        foreach ($arrayRetiros as $retiro) 
        {
            ...
            {
                if($cliente->_nroDeCuenta == $retiro->_nroDeCuenta && $cliente->_estaActivo)
                {
                    if($retiro->_tipoDeCuenta == $TipoDeCuenta && $retiro->_fecha == $fecha)
                    {
